...
p. This will connect to the database when the child first starts, and log that it's done so. The Apache config for this will look something like:

bc.. RubyRequire child_db_inithandler
...
p. When the server starts up, you'll see log messages like:

bc. [Sat Nov 13 13:41:13 2010] [notice] Apache/2.2.15 (Unix) mod_ruby/1.3.0 Ruby/1.8.7(2009-06-12) configured -- resuming normal operations
